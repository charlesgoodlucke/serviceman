...
<html lang="en">
  <head>
    ...
    <title>CST - Tutorials Taken </title>
				...
				<a class="navbar-brand" href="#index.html">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<div class="form-inline ml-lg-3">
							<a href="givetutorial.html" class="btn btn-primary theme-button">Give a Tutorial</a>
						</div>
					</div>
				</nav>
			</div>
...
<section class="w3l-skill-breadcrum">
  <div class="breadcrum">
    <div class="container">
        <p class="fa fa-home"><a href="findtutor.php">Home</a> &nbsp; | &nbsp; <p class="fa fa-arrow-right"><a href="tutorials 2.php">Given</a></p>
    </div>
  </div>
</section>
<!-- //breadcrum -->
    ...
    <div class="container py-lg-5">
      <div class="header-section text-center">
        <h3 class="mb-2">All Tutorials</h3>
		  <small>TAKEN BY YOU</small>
      </div>
</div>
		
		<!--Tutorials taken-->
		
	<center> <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Course Title" title="Type in a name">
...
<?php
    ...
    $sql = "SELECT * FROM give_tutorial WHERE c_title='$phone' ";
