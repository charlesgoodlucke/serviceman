  ...
  return (
    <footer className="pt-32 pb-10 px-6">
      <div className="max-w-7xl mx-auto">
        <div id="download" className="bg-brand-dark text-white rounded-[3rem] p-24 text-center mb-12">
          <h2 className="text-7xl font-display font-bold tracking-tight mb-6">Download the app</h2>
        ...
        <div className="flex flex-row justify-between items-center py-6 border-b border-gray-200 gap-6">
          ...
          <div className="flex flex-col items-end text-sm text-gray-500 font-medium">
        ...
        <div className="flex flex-row justify-between items-center py-8 text-sm text-gray-500 font-medium gap-4">
